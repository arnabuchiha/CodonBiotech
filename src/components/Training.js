                    ...
                    <div className="container">
                        <div className="row pt-5" style={{paddingTop:"15px"}}>
                            <div className="col-lg-6" style={{ textAlign:"left"}}>
                                <p><strong>SKILL DEVELIPMENT / TRAININGS :</strong> Codon Biotech believes in imparting complete hands on practical 
                        ...
                        <div className="row">
                            ...
                            <ul>
                                <li><i class="far fa-dot-circle" style={{color:"#5dd39e", padding:"5px"}}></i>Molecular Biology</li><br/>
                                <li><i class="far fa-dot-circle" style={{color:"#5dd39e", padding:"5px"}}></i>Immunology</li><br/>
                                <li><i class="far fa-dot-circle" style={{color:"#5dd39e", padding:"5px"}}></i>Forensic Sciences</li><br/>
                                <li><i class="far fa-dot-circle" style={{color:"#5dd39e", padding:"5px"}}></i>Recombinant DNA Technology</li><br/>
                            </ul>
